...
{    
    ...
    /// 仓储
    /// </summary>
    public class AptTimeperiodConfigRepository : SCRMRespositoryBase<AptTimeperiodConfig,string>, IAptTimeperiodConfigRepository {
        ...
        public AptTimeperiodConfigRepository( IDbContextProvider<SCRMDbContext> dbContextProvider, ISqlQuery sqlQuery) : base( dbContextProvider ) {
            _sqlQuery = sqlQuery;
        }
    }
}
