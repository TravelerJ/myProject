...
{    
    ...
    /// 仓储
    /// </summary>
    public class FinanceTagConfigRepository : SCRMRespositoryBase<FinanceTagConfig,string>, IFinanceTagConfigRepository {
        ...
        public FinanceTagConfigRepository( IDbContextProvider<SCRMDbContext> dbContextProvider, ISqlQuery sqlQuery) : base( dbContextProvider ) {
            _sqlQuery = sqlQuery;
        }
    }
}
