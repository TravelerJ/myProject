...
{    
    ...
    /// 仓储
    /// </summary>
    public class ResFileMstrRepository : SCRMRespositoryBase<ResFileMstr,string>, IResFileMstrRepository {
        ...
        public ResFileMstrRepository( IDbContextProvider<SCRMDbContext> dbContextProvider, ISqlQuery sqlQuery) : base( dbContextProvider ) {
            _sqlQuery = sqlQuery;
        }
    }
}
