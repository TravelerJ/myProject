...
{    
    ...
    /// 仓储
    /// </summary>
    public class MdmMsgConfigRepository : SCRMRespositoryBase<MdmMsgConfig,string>, IMdmMsgConfigRepository {
        ...
        public MdmMsgConfigRepository( IDbContextProvider<SCRMDbContext> dbContextProvider, ISqlQuery sqlQuery) : base( dbContextProvider ) {
            _sqlQuery = sqlQuery;
        }
    }
}
