...
{    
    ...
    /// 仓储
    /// </summary>
    public class WctOpTokenRepository : SCRMRespositoryBase<WctOpToken,string>, IWctOpTokenRepository {
        ...
        public WctOpTokenRepository( IDbContextProvider<SCRMDbContext> dbContextProvider, ISqlQuery sqlQuery) : base( dbContextProvider ) {
            _sqlQuery = sqlQuery;
        }
    }
}
