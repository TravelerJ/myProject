...
{    
    ...
    /// 仓储
    /// </summary>
    public class MdmGoodsSplRepository : SCRMRespositoryBase<MdmGoodsSpl,string>, IMdmGoodsSplRepository {
        ...
        public MdmGoodsSplRepository( IDbContextProvider<SCRMDbContext> dbContextProvider, ISqlQuery sqlQuery) : base( dbContextProvider ) {
            _sqlQuery = sqlQuery;
        }
    }
}
