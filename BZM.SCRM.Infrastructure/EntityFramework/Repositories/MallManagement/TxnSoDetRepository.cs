...
{    
    ...
    /// 仓储
    /// </summary>
    public class TxnSoDetRepository : SCRMRespositoryBase<TxnSoDet,string>, ITxnSoDetRepository {
        ...
        public TxnSoDetRepository( IDbContextProvider<SCRMDbContext> dbContextProvider, ISqlQuery sqlQuery) : base( dbContextProvider ) {
            _sqlQuery = sqlQuery;
        }
    }
}
